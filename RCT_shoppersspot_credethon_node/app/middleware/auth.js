...
var allowed = [
    ...
    {url: '/user/',method:'GET'},
    {url: '/user/',method:'PUT'},
    {url: '/products/product', method: 'POST'},
    {url: '/add-doc-details', method: 'POST'},
    {url: '/addcarts/doc-details', method: 'GET'},
    {url: '/add-orders', method: 'POST'},
    {url: '/orders-details', method: 'GET'},
    {url: '/masterdata', method: 'GET'},
    {url: '/addcarts/get-track-Details', method: 'GET'},
    {url: '/getProductById', method: 'POST'},
    {url: '/delete-product', method: 'DELETE'},
    {url: '/paymentfororders-pricelist', method: 'POST'},
    {url: '/deleteo-rders-from-orderhistory', method: 'DELETE'},
];
